 ...
 * @author acer
 */
public class PembayaranA extends javax.swing.JFrame {

    /**
     * Creates new form PembayaranA
     */
    public PembayaranA() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("PILIH TRANSAKSI PEMBAYARAN");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PembayaranA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PembayaranA().setVisible(true);
            }
        });
    }
